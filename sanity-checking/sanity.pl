...
#my $primary_address = "192.168.0.107";
#my $primary_address = "172.19.118.128";
#my $primary_address = "192.168.65.3";
#my $primary_address = "192.168.96.1";
...
#	'192.168.0.110'
#);
push @addresses, keys( $psconfigObj->{'addresses'} );


warn "addresses " . Dumper \@addresses;

my $config_archive_name = "config-archive0";
my $config_archive = $psconfigObj->{'archives'}->{ $config_archive_name }->{'data'}->{'url'};

warn "config_archive " . Dumper $config_archive;
...
foreach my $host (@addresses) {
    ...
    $host_status->{'_collection'}->{'collection_name'} = $hosts_obj->{'collection_name'};
    $host_status->{'_collection'}->{'run_id'} = $hosts_obj->{'run_id'};
    $host_status->{'_collection'}->{'probe_address'} = $hosts_obj->{'probe_address'};
